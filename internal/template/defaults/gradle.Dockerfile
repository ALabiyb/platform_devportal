# =============================================================================
# Production Dockerfile — Spring Boot / Gradle
# JAR is built by Jenkins (gradle bootJar --no-daemon) before this runs.
# This stage is runtime-only — no JDK, no Gradle, no source code in the image.
#
...
# JAR produced by: gradle bootJar --no-daemon
